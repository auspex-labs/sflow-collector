...
while True:
    ...
    for i in range(sFlowData.NumberSample):
        ...
        for j in range(sFlowData.samples[i].recordCount):
            ...
            print("Record Enterprise:",
                  sFlowData.samples[i].records[j].enterprise)
            print("Record Sample Type:",
                  sFlowData.samples[i].records[j].sampleType)
            ...
            if sFlowData.samples[i].records[j].sampleType == 1:
                if sFlowData.samples[i].records[j].format == 1 and sFlowData.samples[i].records[j].enterprise == 0:
                    record = sflow.sFlowRawPacketHeader(
                        sFlowData.samples[i].records[j].len, sFlowData.samples[i].records[j].data)
                    ...
                    record = sflow.sFlowEthernetFrame(
                        sFlowData.samples[i].records[j].len, sFlowData.samples[i].records[j].data)
                    ...
                    record = sflow.sFlowExtendedSwitch(
                        sFlowData.samples[i].records[j].len, sFlowData.samples[i].records[j].data)
                    ...
                    print("Flow Record Enterprise:",
                          sFlowData.samples[i].records[j].enterprise)
                    print("Flow Record Type:",
                          sFlowData.samples[i].records[j].format)
            elif sFlowData.samples[i].records[j].sampleType == 2:
                if sFlowData.samples[i].records[j].format == 1:
                    record = sflow.sFlowIfCounters(
                        sFlowData.samples[i].records[j].len, sFlowData.samples[i].records[j].data)
                    ...
                    record = sflow.sFlowEthernetInterface(
                        sFlowData.samples[i].records[j].len, sFlowData.samples[i].records[j].data)
                    ...
                    record = sflow.sFlowHostCPU(
                        sFlowData.samples[i].records[j].len, sFlowData.samples[i].records[j].data)
                    # print("Counter 2003")
                elif sFlowData.samples[i].records[j].format == 2004:
                    record = sflow.sFlowHostMemory(
                        sFlowData.samples[i].records[j].len, sFlowData.samples[i].records[j].data)
                    ...
                    print("Counter Record Enterprise:",
                          sFlowData.samples[i].records[j].enterprise)
                    print("Counter Record Type:",
                          sFlowData.samples[i].records[j].format)
            else:
                print("Sample Type",
                      sFlowData.samples[i].records[j].sampleType)
                print("Sample Record Enterprise:",
                      sFlowData.samples[i].records[j].enterprise)
                print("Sample Record Type:",
                      sFlowData.samples[i].records[j].format)
